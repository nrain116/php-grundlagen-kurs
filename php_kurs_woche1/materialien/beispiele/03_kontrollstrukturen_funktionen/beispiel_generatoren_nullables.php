...
<body>
    ...
    <main class="container">
        ...
        <!-- Generatoren liefern als Rückgabe immer einen Objekt, über welches iteriert werden kann -->

        <?php echo '<pre>', var_dump(wuerfelGenerator()), '</pre>'; ?>

        <p>
            <?php foreach (wuerfelGenerator() as $val): ?>
                <?= $val; ?>
            <?php endforeach; ?>
        </p>
        ...
        function ausgabe(?array $a): string
        {
            ...
            $ret = '';
            foreach ($a as $v) $ret .= "$v, ";
            return $ret;
        }

        ?>

        <p><?= ausgabe(['Apfel', 'Mandarinen', 'Orangen']); ?></p>
