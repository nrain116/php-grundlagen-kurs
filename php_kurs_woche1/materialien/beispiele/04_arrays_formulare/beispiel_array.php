...
<body>
  ...
  <main class="container">
    ...
    <?php $country = 'Schweiz'; ?>
    <p>Die Hauptstadt von <?= $country ?> ist <?= $capitalCities[$country] ?></p>

    <?php foreach ($capitalCities as $country => $city): ?>
      <p><?= $country ?> : <?= $city ?></p>
    <?php endforeach; ?>

    <h2>Unsere aktuellen Beiträgen</h2>
